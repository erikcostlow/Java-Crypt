 ...
 */
package com.costlowcorp.eriktools.code;
...
public class CodeEditor{
    ...
    public static CodeArea make(String text) {
        ...
        codeArea.richChanges()
                ...
                .filterMap(t -> {
                    if (t.isSuccess()) {
                        ...
                        Notifications.create().title("Unable to parse code").text(t.getFailure().getMessage()).showError();
                        return Optional.empty();
                    }
                })
                .subscribe(s -> applyHighlighting(codeArea, s));
